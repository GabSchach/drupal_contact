 ...
 * @endcode
 */
$settings['hash_salt'] = 'cEei2nm0qlI7Q9cn5e34EmHicOHiVqtmbM9UAMj1HJH9LMPGPnO8wmK7KY0JqSS9vss132Wbpw';
...
$databases['default']['default'] = [
  'driver' => 'sqlite',
  'database' => '/workspaces/drupal_contact/web/sites/default/files/drupal.sqlite',
  'prefix' => '',
];
$settings['file_public_path'] = 'sites/default/files';
...
$settings['config_sync_directory'] = 'sites/default/files/config_GNlHvhAKFgyyWeeSByjOFOSzdcDd4G7_aN4TJcHw5VbD1YCeqtT8A6qjqLgJww2pf6NUsMMkJA/sync';
